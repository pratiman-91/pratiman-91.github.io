...
- template: hero-banner-w-image
  block: hero-2
  id: home
  headline: Welcome my  <strong>homepage!</strong>
...
- template: three-columns
  ...
  col_1: 
    ...
    content: <p>Hydrological Modelling</p>          <p>Numerical weather prediction</p>          <p>Extreme precipitation forecast</p>        <p>Land surface feedback</p>          <p>Remote sensing</p>          <p>Geographic information system</p>
  col_2:
    headline: <strong>Skills</strong>
    content: <p>Weather Research & Forecasting Model</p> <p>Hydrological Modelling</p> <p>Remote Sensing & GIS</p> <p>Python/NCL/R</p> <p>Bash</p>
  col_3:
